          ...
          <div className="animate-fade-up opacity-0 flex flex-col pt-4" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="bg-gray-50 dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-xl p-8 mb-10">
              ...
              <div className="flex flex-col font-mono text-sm">
                {product.material && (
                  <div className="flex py-3 border-b border-gray-200 dark:border-brand-border/50 bg-gray-100 dark:bg-brand-steel/30 px-4 rounded-t-lg">
                ...
                {product.ld_ratio && (
                  <div className="flex py-3 border-b border-gray-200 dark:border-brand-border/50 bg-gray-100 dark:bg-brand-steel/30 px-4">
                ...
                {Object.entries(specs).map(([k, v], i) => (
                  <div key={k} className={`flex py-3 border-b border-gray-200 dark:border-brand-border/50 px-4 ${i % 2 === (product.ld_ratio ? 0 : 1) ? '' : 'bg-gray-100 dark:bg-brand-steel/30'}`}>
                    <span className="text-gray-600 dark:text-brand-muted w-1/2 uppercase tracking-wider">{k}</span>
            ...
            <div className="bg-gray-50 dark:bg-brand-steel border border-gray-200 dark:border-brand-border rounded-xl p-8 sticky bottom-6 shadow-2xl">
