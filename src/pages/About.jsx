...
export default function About() {
  return (
    <div className="bg-white dark:bg-brand-dark transition-colors min-h-screen font-body text-gray-900 dark:text-brand-light pb-20">
      ...
      {/* Hero Section */}
      <section className="bg-gray-50 dark:bg-brand-steel border-b border-gray-200 dark:border-brand-border py-32 text-center relative overflow-hidden transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <p className="text-gray-600 dark:text-brand-muted text-xl animate-fade-up opacity-0 delay-[400ms]" style={{ animationFillMode: 'forwards' }}>
      ...
      {/* Stats Section */}
      <section className="bg-white dark:bg-brand-card border-y border-gray-200 dark:border-brand-border -mt-1 relative z-20 transition-colors">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="absolute left-1/2 -ml-px top-0 bottom-0 w-0.5 bg-gray-200 dark:bg-brand-border hidden md:block"></div>
      ...
      {/* Values Grid */}
      <section className="py-24 max-w-7xl mx-auto px-6 border-t border-gray-200 dark:border-brand-border">
        <div className="text-center mb-16">
          <h2 className="font-display text-5xl text-gray-900 dark:text-white uppercase">Core Values</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-50 dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-xl p-8 hover:border-brand-accent transition-colors group">
            <Target size={40} className="text-brand-accent mb-6 group-hover:scale-110 transition-transform" />
            <h3 className="font-display text-2xl text-gray-900 dark:text-white uppercase mb-4">Precision</h3>
            <p className="text-gray-600 dark:text-brand-muted text-sm leading-relaxed">Tolerances held to exact micrometers. Zero-defect philosophy across all lines.</p>
          </div>
          <div className="bg-gray-50 dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-xl p-8 hover:border-brand-accent transition-colors group">
            <Shield size={40} className="text-brand-accent mb-6 group-hover:scale-110 transition-transform" />
            <h3 className="font-display text-2xl text-gray-900 dark:text-white uppercase mb-4">Integrity</h3>
            <p className="text-gray-600 dark:text-brand-muted text-sm leading-relaxed">Transparent quoting, certified raw materials, and accurate lead times.</p>
          </div>
          <div className="bg-gray-50 dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-xl p-8 hover:border-brand-accent transition-colors group">
            <Zap size={40} className="text-brand-accent mb-6 group-hover:scale-110 transition-transform" />
            <h3 className="font-display text-2xl text-gray-900 dark:text-white uppercase mb-4">Output</h3>
            <p className="text-gray-600 dark:text-brand-muted text-sm leading-relaxed">Our designs maximize your machine's hourly output while reducing motor load.</p>
          </div>
          <div className="bg-gray-50 dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-xl p-8 hover:border-brand-accent transition-colors group">
            <Award size={40} className="text-brand-accent mb-6 group-hover:scale-110 transition-transform" />
            <h3 className="font-display text-2xl text-gray-900 dark:text-white uppercase mb-4">Quality</h3>
            <p className="text-gray-600 dark:text-brand-muted text-sm leading-relaxed">Rigorous multi-stage inspections before a single screw leaves our facility.</p>
          </div>
        </div>
      </section>

      {/* CTA Section */}
      <section className="bg-white dark:bg-brand-card py-20 border-y border-gray-200 dark:border-brand-border text-center overflow-hidden relative transition-colors">
        ...
        <div className="relative z-10 px-6">
          <h2 className="font-display text-5xl md:text-6xl text-gray-900 dark:text-white uppercase mb-8">Let's Build Together</h2>
